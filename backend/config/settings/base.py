...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='enquire_db'),
...
# ---------- Download ----------
DOWNLOAD_LINK_EXPIRY_HOURS = config('DOWNLOAD_LINK_EXPIRY_HOURS', default=72, cast=int)
DOWNLOAD_MAX_USES = config('DOWNLOAD_MAX_USES', default=5, cast=int)

# ---------- IPInfo (location lookup) ----------
